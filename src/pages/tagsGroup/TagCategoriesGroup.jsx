...
function TagCategoriesGroup(props) {
	const { categories, createCategoryGroup, updateCategoryGroup, deleteCategoryGroup, findCategory, category } = useTag("tagCategoriesGroup")
	...
	const handleActionClick = (e, action, id, category) => {
		...
		if (action === 'delete')
			deleteModal({
				...
				onOk: () => deleteCategoryGroup(category._id),
			})
	}
	const handleUpdate = async values => {
		updateCategoryGroup(category._id, values)
			.then(() => {
...
export default TagCategoriesGroup
